...
public interface ITSqlParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterBuilt_in_functions([NotNull] TSqlParser.Built_in_functionsContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="TSqlParser.built_in_functions"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitBuilt_in_functions([NotNull] TSqlParser.Built_in_functionsContext context);
