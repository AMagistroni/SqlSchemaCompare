...
public partial class TSqlParserBaseListener : ITSqlParserListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterBuilt_in_functions([NotNull] TSqlParser.Built_in_functionsContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="TSqlParser.built_in_functions"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitBuilt_in_functions([NotNull] TSqlParser.Built_in_functionsContext context) { }
